...
function t9() {
    ...
    out_9.innerHTML = document.querySelector('.i-9').value;
...
function t10() {
    ...
    out_10.innerHTML = document.querySelector('.i-10').value * 20;
}
...
function t11() {
    ...
    out_11.innerHTML = document.querySelector('.i-11').value + 55;
}
...
function t12() {
    ...
    out_12.innerHTML = 'Hello ' + name + ' ' +  surName;
}
