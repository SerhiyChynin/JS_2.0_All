...
function f5() {
    ...
    if (i_5.checked) {
    document.querySelector('.out-5').innerHTML = i_5.value;
    }
    else {
...
function f6() {
    ...
    document.querySelector('.out-6').innerHTML = i_6.value;
...
function f7() {
    ...
    out_71.innerHTML = i_7.value
    if (i_7.value.length < 6 && i_7.value.length != 6 ) {
        out_72.innerHTML = 0
    }
    else if(i_7.value.length >= 6 ) {
        out_72.innerHTML = 1
    }
...
function f8() {
    ...
    out_8.innerHTML += '<div class="js2">new div</div>';
...
function f9() {
    ...
    if (r_9.checked) {
        out_9.innerHTML = 'radiobutton';
    }
    else {
        out_9.innerHTML = false;
    }
}
...
function f14() {
    ...
    let i_14 = document.querySelector('.t-14');
    out_14.innerHTML = i_14.value
}
...
function f18() {
    ...
    let out_18 = document.querySelector('.i-18');    
    out_18.value = select;
}
...
function f19() {
    ...
    console.log(out_19.outerText);
    let i_19 = document.querySelector('.i-19');
    i_19.value = out_19.innerHTML;
}
...
function f20() {
    let s_201 = document.querySelector('.s-201');    
    let s_202 = document.querySelector('.s-202');
    s_202.value = s_201.value;
}
