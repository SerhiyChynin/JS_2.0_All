...
const f4 = () => {
   ...
   document.querySelector('.out-4').innerHTML = s4.has(i_4);
...
const f9 = our_set => {
    let ar = Array.from(our_set).join(' ');
    return ar;
 }
...
const f10 = (out_set, elem) => {
    let ar = Array.from(out_set).join(' ');
    document.querySelector(elem).textContent = ar;
