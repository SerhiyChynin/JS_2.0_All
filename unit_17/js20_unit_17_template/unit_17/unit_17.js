...
function t4() {
    a4_res = a4.filter(item => Number.isInteger(item));
    return a4_res;
}
...
function t5() {
    a5_res = a5.filter(item => Number.isInteger(item) && item % 2 === 0);
    return a5_res;
}
...
function t6() {
    a6_res = a6.filter(item => Number.isInteger(item) && item > 14);
    return a6_res;
}
...
function t9() {
    let t = [];
    a9.forEach(item => t.push(item.toLowerCase()));
    a9 = t;
    return a9;
}
...
function t10() {
    let t = [];
    a10.forEach(item => t.push(item < 0 ? item = 0 : item));
    a10 = t;
    return a10;
}
...
function t11() {
    let a11_res = a11.filter((item, index) => index % 2 === 0);
    return a11_res;
...
function t15() {
    a15_res = a15.filter(item => item.pnum !== '' && item.pnum.length == 6)
return a15_res
}
