...
function f3() {
    ...
    out_3.classList.remove('bg-orange');
}
...
function f4() {
    out_4.classList.toggle('bg-orange');
}
...
function f5() {
    ...
    if (out_4.classList[1] == 'bg-orange') {
...
function f7() {
    ...
    let out_7 = document.querySelectorAll('.out-7');
    for (let i = 0; i < out_7.length; i++){
    out_7[i].classList.add('bg-orange');
    }
}
...
function f8() {
    ...
    let out_8 = document.querySelectorAll('.out-8');
    for (let i = 0; i < out_8.length; i++){
    out_8[i].classList.toggle('bg-orange');
    }
}
