...
function t7() {
    ...
    console.log(i_7.value);
    for (let i = i_7.value; i >= 0; i--) {
...
function t8() {
    ...
    for (let i = i_81.value; i < i_82.value; i++){
        out += i + '_';
    }
...
function t9() {
    ...
    if (i_91.value > i_92.value) {
        let t = i_91.value;
        i_91.value = i_92.value;
        i_92.value = t;
    }
        for (let i = i_91.value; i <= i_92.value; i++){
            out += i + '_';
        }
