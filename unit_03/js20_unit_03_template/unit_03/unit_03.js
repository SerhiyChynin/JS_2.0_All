...
function f3(){
   ...
   if (+i_31.value > +i_32.value) {
      out_3.innerHTML = +i_31.value;
   }
      else {
      out_3.innerHTML = +i_32.value;
      }
}
...
function f7(){
   ...
   out_7.innerHTML = (+i_71.value) ** (+i_72.value);
}
...
function f9(){
   ...
   if (+i_9.value >= 1 && +i_9.value <= 32) {
      out_9.innerHTML = 1;
   }
   else if (+i_9.value >= 33 && +i_9.value <= 43) {
      out_9.innerHTML = 2;
   }
   else if (+i_9.value >= 44 && +i_9.value <= 64){
      out_9.innerHTML = 3;
   }
   else {
      out_9.innerHTML = 0;
...
function f14(){
   ...
   let s_143 = document.querySelector('.s-143');
      switch (s_143.value){ 
      case '+':
         out_14.innerHTML = (+i_141.value) + (+i_142.value);
         break;
      case '-':
         out_14.innerHTML = (+i_141.value) - (+i_142.value);
         break;
...
function f15(){
   ...
   let i_151 = document.querySelector('.s-151');
   let i_152 = document.querySelector('.s-152');
   let s_153 = document.querySelector('.s-153');
   console.log(i_151.value);
         switch (s_153.value){ 
      case '&&':
         out_15.innerHTML = (i_151.value) + s_153.value + (i_152.value);
         break;
      case '||':
         out_15.innerHTML = (i_151.value) + s_153.value +  (i_152.value);
         break;
